...
login_yandex = os.getenv('LOGIN')
password_yandex = os.getenv('PASSWORD')

sender_email = 'Johnnie.Walker.90@yandex.ru'
recipient_email = 'Johnnie.Walker.90@yandex.ru'
subject = 'Invitation!'
website = 'https://dvmn.org/https://dvmn.org/profession-ref-program/nizhnikov.e/rJUbD/'
friend_name = 'Иван'
my_name = 'Евгений'
letter = '''\
from: {0} 
...
server.login(login_yandex, password_yandex)
